# -*- coding: utf-8 -*-
"""
Created on Mon Nov 16 20:55:37 2020
...
if __name__ == "__main__":
    dirpath = './resources/yosemite'
    ds1, auc1, roc1 = benchmark_dir(dirpath, HarrisKeypointDetector(), MOPSFeatureDescriptor(), SSDFeatureMatcher(),
    0.1, 0.6)
    ds2, auc2, roc2 = benchmark_dir(dirpath, HarrisKeypointDetector(), SimpleFeatureDescriptor(), SSDFeatureMatcher(),
    0.1, 0.6)
    
    ds3, auc3, roc3 = benchmark_dir(dirpath, HarrisKeypointDetector(), MOPSFeatureDescriptor(), RatioFeatureMatcher(),
    0.1, 0.16)
    ds4, auc4, roc4 = benchmark_dir(dirpath, HarrisKeypointDetector(), SimpleFeatureDescriptor(), RatioFeatureMatcher(),
    0.1, 0.6)
    #打印AUC
    print(auc1)
    print(auc2)
    ...
    # 画ROC图
    a1 = np.vstack((roc1,roc3))
    a2 = np.vstack((roc2,roc4))
    a = np.hstack((a1,a2))
    
    new_im1 = Image.fromarray(a)
